...
def streamlit_app():
    ...
    st.markdown(
        '<div style="text-align:center;font-size:1.2rem;margin-bottom:30px">Advanced AI Emotion Detection from Speech Patterns</div>',
        unsafe_allow_html=True)
    ...
    st.markdown('<div class="footer">Advanced Speech Emotion Recognition System | University Project</div>',
                unsafe_allow_html=True)
